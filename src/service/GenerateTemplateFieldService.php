 ...
 * 生成文档模板
 */
class GenerateTemplateFieldService extends Base implements MainModelInterface {
    ...
    protected static $mainModelClass = '\\xjryanse\\generate\\model\\GenerateTemplateField';
     ...
     * 20220815:求和字段
     */
    public static function sumFields($templateId) {
        $con[] = ['template_id', '=', $templateId];
        $con[] = ['is_sum', '=', 1];
        return self::staticConColumn('field_name', $con);
    }
